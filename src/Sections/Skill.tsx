  ...
  return (
    <div
      ...
      <Box className="heading " >
        <Typography variant="h3" sx={{color:"#434343",fontWeight:"bold"}}>Skills & Hobbies</Typography>
      </Box>

      <section className="content">


        <section className="back" style={{ position: "absolute", top: "-300px", width: "70%", height: "20%", zIndex: "-1" }} >
        ...
        {/* <Container className="terminal" sx={{ display: "flex", justifyContent: "center",border:"1px dashed grey" }}> */}
          <Terminal />
        {/* </Container> */}
      </section>
